  ...
  <div>
    ...
    <div class="container px-4 md:px-0 max-w-6xl mx-auto -mt-32">
      ...
      <div class="mx-0 sm:mx-6 mt-12">
        <div class="bg-gray-200 w-full min-h-[50vh] leading-normal rounded-t p-0">
          <!--Lead Card-->
            ...
            <a href="post.html" class="flex flex-wrap no-underline hover:no-underline">
              ...
              <div class="w-full md:w-1/3 flex flex-col flex-grow flex-shrink">
                <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow-lg">
                  ...
                  <div class="w-full font-bold text-xl text-gray-900 px-6">👋 Welcome fellow Tailwind CSS and Ghost fan
                  </div>
...
export default {
  ...
  async asyncData({ $content, i18n }) {
    const page = await $content(i18n.locale, 'pages', 'index').fetch();
    return {
      page: {
        title: page.title,
